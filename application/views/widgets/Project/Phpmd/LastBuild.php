...
<div id="widget_<?php echo $widget->id; ?>" class="grid grid_2 grid_v2 clickable build-<?php echo $build->status; ?>">
    <img src="img/freepik/flag.png" width="32" height="32" style="float: right"/>
    ...
    <h4>
        ...
        if ($build->status == "building") {
            ...
            echo 'Queued';
        } else if (!empty($build->phpmd_globaldata->id)) {
            if ($build->phpmd_globaldata->errors > 0) {
                echo '<img src="img/freepik/warning.png" width="52" style="vertical-align: middle"/><br/>' . $build->phpmd_globaldata->errors;
            } else {
